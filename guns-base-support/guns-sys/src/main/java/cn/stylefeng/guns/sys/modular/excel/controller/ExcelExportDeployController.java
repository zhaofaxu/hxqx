package cn.stylefeng.guns.sys.modular.excel.controller;
...
public class ExcelExportDeployController extends BaseController {
    ...
    public ResponseData uploadTemplate(@RequestPart("file") MultipartFile file) {
        try {
            ...
            fileSavePath = fileSavePath + "/uploadFiles/excelExportTemplate/";
            ...
            return ResponseData.success("/excelExportDeploy/download/" + uploadResult.getFinalName());
        } catch (Exception e) {
            e.printStackTrace();
